...
import { runAutoAnnotatorAction, runQCAgentAction } from '../actions';
...
export default function AnnotatorView() {
    ...
    const handleRunWorkbench = async () => {
        ...
        setAgentError(null);
        try {
            const result = await runAutoAnnotatorAction(workbenchText);
    ...
    const handleRunQC = async () => {
        ...
        setAgentError(null);
        try {
            const result = await runQCAgentAction(workbenchText, workbenchAnnotation);
            ...
            // Map suggestions for easier lookup by field path
    ...
    const handleApplySuggestion = (suggestion: UiSuggestion) => {
        ...
        // Handle array indices like labels[0]
                                        ...
                                        <div>
                                            <div className="flex items-center gap-2">
                                                ...
                                                {workbenchAnnotation.confidence !== undefined && (
                                                    <Badge variant={workbenchAnnotation.confidence > 0.8 ? "default" : "secondary"} className="text-xs">
